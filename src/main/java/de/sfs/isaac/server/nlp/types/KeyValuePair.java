 ...
 * @generated */
public class KeyValuePair extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "de.sfs.isaac.server.nlp.types.KeyValuePair";
  ...
  private final static CallSite _FC_key = TypeSystemImpl.createCallSite(KeyValuePair.class, "key");
  private final static MethodHandle _FH_key = _FC_key.dynamicInvoker();
  private final static CallSite _FC_value = TypeSystemImpl.createCallSite(KeyValuePair.class, "value");
   ...
   */
  public KeyValuePair(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
  ...
  */  
  public KeyValuePair(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
  ...
  /** getter for value - gets the value
   * @generated
   * @return value of the feature 
   */
  ...
  /** setter for value - sets the value 
   * @generated
   * @param v value to set into the feature 
   */
